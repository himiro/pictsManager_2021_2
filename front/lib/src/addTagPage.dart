...
class AddTagPage extends StatefulWidget {
  ...
  @override
  _AddTagPageState createState() => _AddTagPageState(this.imageUrl);
}
...
class _AddTagPageState extends State<AddTagPage> {
  ...
  _AddTagPageState(@required this.imageUrl);
  ...
  Future<http.Response> addTag(String imageUrl, String tag) async {
    print(imageUrl);
    ...
    taglist = jsonDecode(response.body);
    taglist.add(tag);
    return http.post(
      'http://' +
          Constants.IP_HOST +
  ...
  Widget _submitButton() {
    return InkWell(
      onTap: () async {
        ...
        await addTag(this.imageUrl, _emailController.text);
